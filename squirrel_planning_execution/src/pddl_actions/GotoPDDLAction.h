#ifndef SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_GOTOPDDLCOMMAND_H
#define SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_GOTOPDDLCOMMAND_H
...
public:
	 ...
	 */
	GotoPDDLAction(ros::NodeHandle& node_handle);
