#ifndef SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_DROPOBJECTPDDLCOMMAND_H
#define SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_DROPOBJECTPDDLCOMMAND_H
...
/**
 * An instance of this class gets called whenever the PDDL action 'drop_object' (or variants thereof) is
 * dispatched. It is an action that makes the robot drop an object from waypoint to another.
 */
class DropObjectPDDLAction
{
public:
	 ...
	 */
	DropObjectPDDLAction(ros::NodeHandle& node_handle);
	
	/**
	 * Destructor
	 */
	~DropObjectPDDLAction();
