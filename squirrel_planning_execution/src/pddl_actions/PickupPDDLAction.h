#ifndef SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_PICKUPPDDLCOMMAND_H
#define SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_PICKUPPDDLCOMMAND_H
...
public:
	 ...
	 */
	PickupPDDLAction(ros::NodeHandle& node_handle);
