#ifndef SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_FOLLOWCHILDPDDLCOMMAND_H
#define SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_FOLLOWCHILDPDDLCOMMAND_H
...
/**
 * An instance of this class gets called whenever the PDDL action 'follow_child' (or variants thereof) is
 * dispatched. It is an action that makes the robot play a sound and wiggle.
 */
class FollowChildPDDLAction
{
public:
	 ...
	 */
	FollowChildPDDLAction(ros::NodeHandle& node_handle);
	
	/**
	 * Destructor
	 */
	~FollowChildPDDLAction();
