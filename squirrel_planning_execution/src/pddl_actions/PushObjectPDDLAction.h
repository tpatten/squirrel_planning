#ifndef SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_PUSHOBJECTPDDLCOMMAND_H
#define SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_PUSHOBJECTPDDLCOMMAND_H
...
/**
 * An instance of this class gets called whenever the PDDL action 'push_object' (or variants thereof) is
 * dispatched. It is an action that makes the robot push an object from waypoint to another.
 */
class PushObjectPDDLAction
{
public:
	 ...
	 */
	PushObjectPDDLAction(ros::NodeHandle& node_handle);
	
	/**
	 * Destructor
	 */
	~PushObjectPDDLAction();
