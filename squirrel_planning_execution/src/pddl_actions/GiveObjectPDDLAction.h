#ifndef SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_GIVEOBJECTPDDLCOMMAND_H
#define SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_GIVEOBJECTPDDLCOMMAND_H
...
public:
	 ...
	 */
	GiveObjectPDDLAction(ros::NodeHandle& node_handle);
	
	/**
	 * Destructor
	 */
	~GiveObjectPDDLAction();
