#ifndef SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_CHILDRENPDDLCOMMAND_H
#define SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_CHILDRENPDDLCOMMAND_H
...
public:
	 ...
	 */
	ChildrenPDDLAction(ros::NodeHandle& node_handle);
